            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <?php if(auth()->check()): ?>
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('dashboard')); ?>">Przejdz do profilu</a></li>
    <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\projekt\Krzysztof_Dobosz\resources\views/index.blade.php ENDPATH**/ ?>