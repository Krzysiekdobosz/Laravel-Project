<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Jeżeli usuniesz konto wszystkie twoje dane przepadną..')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Usuń  Konto')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">
                <?php echo e(__('Jesteś pewny ze chcesz usunąć konto? ')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600">
                <?php echo e(__('Jeżeli usuniesz konto wszystkie dane przepadną.')); ?>
...
<?php /**PATH C:\xampp\htdocs\projekt\projp — kopia\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>